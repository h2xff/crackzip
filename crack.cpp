...
crackzip::crackzip(std::string filename, std::string dict_file)
{
...
void crackzip::loadzip(std::string filename)
{
    //open file
    FILE *f = nullptr;
...
//open dictionary
void crackzip::open_dict(std::string dict_file)
{
...
{
    std::string cmd="unzip -qqt -P "+pw+" "+filename;
